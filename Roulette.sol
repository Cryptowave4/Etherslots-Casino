...
contract Roulette {
    ...
    uint256 public maxAmountAllowedInTheBank;
    ...
    */
    ...
    constructor(address _rngContract) payable {
        creator = msg.sender;
        necessaryBalance = 0;
        ...
        rng = RandomNumberGenerator(_rngContract);
    }
    ...
    uint256 randomNumber = rng.getCombinedRandomNumber();
    uint256 number = randomNumber % 37;
    ...
    necessaryBalance = 0;
    /* check if too much money in the bank */
